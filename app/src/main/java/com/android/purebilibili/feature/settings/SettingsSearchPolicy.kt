...
private val SETTINGS_SEARCH_INDEX: List<SettingsSearchEntry> = listOf(
    ...
    SettingsSearchEntry(
        ...
        title = "动画与效果 / 触感反馈",
        subtitle = "动画、预测性返回预览、触感反馈、底栏搜索入口",
        section = "外观设置",
        aliases = listOf("动画与效果", "预测性返回", "预测性返回预览", "返回预览", "返回手势预览", "触感反馈", "动画设置", "应用图标", "底栏搜索", "底栏搜索入口", "搜索入口", "悬浮搜索"),
    ...
    SettingsSearchEntry(
        ...
        subtitle = "交互",
        section = "播放设置",
        aliases = listOf("自动连播", "自动播放下一个", "进入视频自动播放", "进入视频不要自动播放", "不要自动播放", "双击点赞", "双击跳转", "取消双击跳转", "关闭双击跳转", "双击快进", "双击后退", "快进秒数", "后退秒数", "关注点赞弹幕", "关注弹幕", "点赞弹幕", "三连弹幕", "弹幕屏蔽", "字幕", "自动启用字幕", "ai总结", "视频简介", "默认展开视频简介", "简介默认展开", "播放器缩小策略", "竖屏视频缩小", "竖屏评论区缩小", "评论上滑缩小播放器", "横屏视频缩小", "上滑隐藏播放器", "播完后收起", "播完评论缩小", "点击视频直接播放"),
